...
and the generated [CHECKS.md](CHECKS.md) for the 132 checks it runs.
...
**132 checks**: 10 critical, 61 warnings, 61 notices. Sources: SF exports,
...
- [CHECKS.md](CHECKS.md) — the 132 checks the SF crawl audit runs, generated from the registry
