...
and the generated [CHECKS.md](CHECKS.md) for the 127 checks it runs.
...
**127 checks**: 10 critical, 58 warnings, 59 notices. Sources: SF exports,
...
- [CHECKS.md](CHECKS.md) — the 127 checks the SF crawl audit runs, generated from the registry
