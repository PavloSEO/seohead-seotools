...
and the generated [CHECKS.md](CHECKS.md) for the 105 checks it runs.
...
**105 checks**: 8 critical, 45 warnings, 52 notices. Sources: SF exports,
...
## Where to go next
- [CHECKS.md](CHECKS.md) — the 105 checks the SF crawl audit runs, generated from the registry
