...
and the generated [CHECKS.md](CHECKS.md) for the 114 checks it runs.
...
**114 checks**: 8 critical, 52 warnings, 54 notices. Sources: SF exports,
...
## Where to go next
- [CHECKS.md](CHECKS.md) — the 114 checks the SF crawl audit runs, generated from the registry
