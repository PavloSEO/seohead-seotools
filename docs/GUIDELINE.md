...
back, and applies 127 checks to that evidence. Then a set of specialised tools answer questions
...
A health score computed from 16 of 127 checks is not a health score. The audit says so in
