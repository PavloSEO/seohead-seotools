...
| Looking for a check the SF audit runs | [CHECKS.md](CHECKS.md) — all 127, generated from the registry |
...
- **[TOOL_REFERENCE.md](TOOL_REFERENCE.md)** — every tool's arguments (name,
  ...
  build if it drifts.
- **[CHECKS.md](CHECKS.md)** — the 127 checks the SF crawl audit runs: what each fires
