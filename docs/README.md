...
| Looking for a check the SF audit runs | [CHECKS.md](CHECKS.md) — all 114, generated from the registry |
...
- **[CHECKS.md](CHECKS.md)** — the 114 checks the SF crawl audit runs: what each fires
