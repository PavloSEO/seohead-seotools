...
52 callable tools · 105 checks over Screaming Frog crawl exports · 28 workflow skills · CLI · local MCP · Docker
...
by SEOHEAD's 105-check analyzer. SEOHEAD then runs complementary bounded checks, keeps failed and
...
| Evidence processing | SEOHEAD Tools | Analyze those exports against a 105-check registry, run targeted live and infrastructure tools, preserve uncertainty, and build structured artifacts |
...
|---|---|---|
| Existing Screaming Frog exports | `seohead sf run --exports-dir ./exports --out ./report --tasks` | Evaluates available crawl evidence against the 105-check registry and builds an audit plus backlog |
...
The analyzer has a registry of **105 checks** across metadata, indexability, canonicals, redirects,
