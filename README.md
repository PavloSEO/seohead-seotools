...
![Tests](https://img.shields.io/badge/tests-610%20offline-BDDDF5)
...
The suite contains **610 offline tests**. CI also checks interface registration, layer boundaries,
