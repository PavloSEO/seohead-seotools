...
![Tests](https://img.shields.io/badge/tests-646%20offline-BDDDF5)
...
The suite contains **646 offline tests**. CI also checks interface registration, layer boundaries,
