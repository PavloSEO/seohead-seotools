...
![Tests](https://img.shields.io/badge/tests-508%20offline-BDDDF5)
...
The suite contains **508 offline tests**. CI also checks interface registration, layer boundaries,
