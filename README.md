...
![Tests](https://img.shields.io/badge/tests-637%20offline-BDDDF5)
...
The suite contains **637 offline tests**. CI also checks interface registration, layer boundaries,
