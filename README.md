...
![Tests](https://img.shields.io/badge/tests-670%20offline-BDDDF5)
...
The suite contains **670 offline tests**. CI also checks interface registration, layer boundaries,
