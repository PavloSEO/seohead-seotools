...
![Tests](https://img.shields.io/badge/tests-566%20offline-BDDDF5)
...
The suite contains **566 offline tests**. CI also checks interface registration, layer boundaries,
