...
![Tests](https://img.shields.io/badge/tests-490%20offline-BDDDF5)
...
The suite contains **490 offline tests**. CI also checks interface registration, layer boundaries,
