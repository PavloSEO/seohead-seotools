...
![Tests](https://img.shields.io/badge/tests-497%20offline-BDDDF5)
...
The suite contains **497 offline tests**. CI also checks interface registration, layer boundaries,
