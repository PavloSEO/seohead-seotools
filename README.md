...
![Tests](https://img.shields.io/badge/tests-585%20offline-BDDDF5)
...
The suite contains **585 offline tests**. CI also checks interface registration, layer boundaries,
