...
![Tests](https://img.shields.io/badge/tests-527%20offline-BDDDF5)
...
The suite contains **527 offline tests**. CI also checks interface registration, layer boundaries,
